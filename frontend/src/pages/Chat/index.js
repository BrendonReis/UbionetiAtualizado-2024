...
import internalNotifySound from "../../assets/chat_internal_notify.mp3";
...
function Chat(props) {
  ...
  const { id } = useParams();
  const [playInternalSound] = useSound(internalNotifySound);
  ...
  }, [currentChat, socketManager, playInternalSound, user.id]);
